...
Vancouver, CA/TransLink support is currently entirely broken, and is unlikely to be implmented any time soon due to their switching away from an API that returns compatible JSON data. Tampa, FL/Hillsborough Area Regional Transit (HART) support has been entirely removed, due to HART discontinuing their public API in April 2025.

As originally developed as and forked from...
# CatchOneBus
